 ...
 * Products.java
 * 
 * Created on Aug 25, 2007, 5:54:04 PM
 * 
...
public class Products extends HttpServlet {
    ...
    */
    ...
    throws ServletException, IOException {
        ...
        Page page=view.initialize("Products","global.css");
        ...
        login.setLastForm("products");
        request.getSession().setAttribute("login", login);
// ********************************
// ** TITLE **            
// ********************************            
            page.text("Products", "titletext", "", "", "", "210px", "125px", "300px", "35px", "3", "", "");
            ...
            page.startTable("stdgrid","200px","175px","468px","30px","4");
                page.startRow();
                    page.startCell("","1","1","");
                        ...
                        //page.space();
                        //page.space();
                        page.text("Register account", "extralinktext", "insert.jpg", "", "newaccount", "35px", "35px");
                    page.endCell();
                page.endRow();
            page.endTable(true);
