 ...
 * Attendant.java
 * 
 * Created on Feb 4, 2008, 3:30:01 PM
 * 
...
public class Attendant extends HttpServlet {
    ...
    */
    ...
    throws ServletException, IOException {
        ...
        Page page=view.initialize("Attendant","global.css");
        ...
        if ((save!=null)) {
            if (!(doctor.getFirstName().equals("")) && !(doctor.getLastName().equals(""))) {
                ...
                if (doctor.save()) {
                    page.text("Therapist", "titletext", "", "", "", "210px", "125px", "300px", "35px", "3", "", "");
                    page.startTable("stdgrid","200px","210px","468px","30px","4");
                        ...
                        page.startRow();
                            page.startCell("","1","1","");
                                page.text("Add another record","","insert.jpg","","attendant?command=2","25px","25px");
                            page.endCell();
                        page.endRow();
                    page.endTable(true);
                    page.flush();
...
// ********************************            
            ...
            page.startForm("editattendant", "attendant", "post");
