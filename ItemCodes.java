 ...
 * ItemCodes.java
 * 
 * Created on Oct 17, 2007, 11:58:21 AM
 * 
 ...
 * @author nsdan2k
 */
public class ItemCodes extends HttpServlet {
...
// ********************************            
            page.startTable("stdgrid","200px","175px","468px","30px","4");
                page.startRow();
                    page.startCell("extralinkcell","1","1","");
                        ...
                        //page.space();
                        //page.space();
                        page.text("New Code", "extralinktext", "insert.jpg", "", "itemcode?command=2", "35px", "35px");
                    page.endCell();
                page.endRow();
            page.endTable(true);
            ...
            page.startTable("boxgrid","200px","220px","468px","3");
                ...
                for (int i=0; i<codes.size(); i++) {
                    ...
                    page.startRow();
                        page.startCell("", "1", "1", "");
                            page.text(code.getCode(), "extralinktext", "", "", "itemcode?id="+code.getId()+"&pg="+pg, "", "");
                        page.endCell();
                        page.startCell("", "1", "1", "");
                        ...
                        if (codes.getSets()>1) {
                            for (int j=1; j<=codes.getSets(); j++) {
                                if (iPg==j) {
                                    ...
                                    page.text("<a href=\"itemcodes?pg="+j+"\">"+j+"</a>&nbsp;","extralinktext","","","","","");
                                }
                                if ((j % bar)==0) {
                                    page.println("<br/>");
                                }
