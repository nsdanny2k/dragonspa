 ...
 * MedicalAlert.java
 * 
 * Created on Sep 13, 2007, 3:44:29 PM
 * 
 ...
 * @author nsdan2k
 */
public class MedicalAlert extends HttpServlet {
    ...
    */
    ...
    throws ServletException, IOException {
        ...
        login.setLastForm("medicalalert");
        ...
        if (login.getAccountId().equals("system")) {
            page=view.initialize("Medical Alert","global.css","System");    
        } else {
            page=view.initialize("Medical Alert","global.css");
        }                
        model.MedicalAlert code=new model.MedicalAlert();
        ...
        if ((save!=null)) {
            if (!(code.getDescription().equals(""))) {
                ...
                if (code.save()) {
                    page.text("Medical Alert", "titletext", "", "", "", "210px", "125px", "300px", "35px", "3", "", "");
                    page.startTable("stdgrid","200px","210px","468px","30px","4");
                        ...
                        if (pg!=null) {
                            page.startRow();
                                page.startCell("","1","1","");
                                    page.text("Return to list","","","","medicalalerts?pg="+pg,"25px","25px");
                                page.endCell();
                            page.endRow();
                        }                         
                        page.startRow();
                            page.startCell("","1","1","");
                                page.text("Add another record","","insert.jpg","","medicalalert?command=2","25px","25px");
                            page.endCell();
                        page.endRow();
                    page.endTable(true);
                    page.flush();
...
// ********************************            
            ...
            page.startForm("editcode", "medicalalert", "post");
