 ...
 * GuestProfile.java
 * 
 * Created on Feb 4, 2008, 3:07:34 PM
 * 
...
public class GuestProfile extends HttpServlet {
    ...
    */
    ...
    throws ServletException, IOException {
        ...
        login.setLastForm("guestprofile");
                ...
                if (patient.save()) {
                    ...
                    page.startTable("stdgrid","200px","210px","468px","30px","4");
                        ...
                        if (pg!=null && pattern!=null) {
                            page.startRow();
                                page.startCell("","1","1","");
                                    page.text("Return to list","","","","guests?pg="+pg+"&command="+pattern,"25px","25px");
                                page.endCell();
                            page.endRow();
                        }                              
                        page.startRow();
                            page.startCell("", "1", "1", "");
                                page.text("Return to record","","insert.jpg","","guestprofile?id="+patient.getPartyId(),"25px","25px");
                            page.endCell();
                        page.endRow();
                    page.endTable(true);
                    page.flush();
...
// ** TITLE **            
// ********************************            
            page.text("Guest Profile", "titletext", "", "", "", "210px", "125px", "300px", "35px", "3", "", "");
        ...
        page.endTable(true);  
            ...
            page.startForm("editguest", "guestprofile", "post");
