 ...
 * Contact.java
 * 
 * Created on Aug 25, 2007, 5:53:24 PM
 * 
...
public class Contact extends HttpServlet {
    ...
    */
    ...
    throws ServletException, IOException {
        ...
        Page page=view.initialize("Contact Us","global.css");
        ...
        login.setLastForm("contact");
        request.getSession().setAttribute("login", login);
// ********************************
// ** TITLE **            
// ********************************            
            page.text("Contact Us", "titletext", "", "", "", "210px", "125px", "300px", "35px", "3", "", "");
