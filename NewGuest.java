 ...
 * NewGuest.java
 * 
 * Created on Feb 4, 2008, 2:56:56 PM
 * 
...
public class NewGuest extends HttpServlet {
    ...
    */
    ...
    throws ServletException, IOException {
        ...
        Page page=view.initialize("Guest Registration","global.css");
        ...
        model.Patient patient=(model.Patient)request.getSession().getAttribute("newpatient");
        ...
        if ((save!=null)) {
            if (!(patient.getFirstName().equals("")) && !(patient.getLastName().equals(""))) {
                ...
                if (patient.save()) {
                    page.text("Guest Registration", "titletext", "patients.jpg", "", "", "210px", "125px", "300px", "35px", "3", "35px", "35px");
                    page.startTable("stdgrid","200px","210px","468px","30px","4");
                        ...
                        int i=patients.search( patient.getFirstName()+" "+patient.getLastName(), login.getAccountId());
                        if (i==1) {
                            model.Patient p=new model.Patient();
                            p=(model.Patient)patients.get(0);
                            /*
                            page.startRow();
                                page.startCell("", "1", "1", "");
                                    page.text("Enter medical history","","","","medicalhistory?id="+p.getPartyId(),"25px","25px");
                                page.endCell();
                            page.endRow();
                             */
                        }
                        page.startRow();
                            page.startCell("", "1", "1", "");
                                page.text("Add another record","","insert.jpg","","newguest","25px","25px");
                            page.endCell();
                        page.endRow();
                    page.endTable(true);
                    page.flush();
        ...
        request.getSession().setAttribute("newpatient",patient);        
// ********************************
// ** TITLE **            
// ********************************            
            page.text("Guest Registration", "titletext", "patients.jpg", "", "", "210px", "125px", "300px", "35px", "3", "35px", "35px");

            page.startForm("newentry", "newguest", "post");
            ...
            //            page.inputImage("save", "saveit.jpg", "");
                        ...
                        //page.inputImage("okclick", "check.jpg", "");
                        //page.text("Cancel", "attribtext", "", "", "", "30px", "30px");
                        //page.inputImage("cancelclick", "cross.jpg", "");
            //        page.endCell();
            //    page.endRow();
            //page.endTable(true);
            ...
            page.startTable("boxgrid","200px","175px","472px","300px","4");
                ...
                page.startRow();
                    ...
                    page.endCell();
                    page.startCell("","1","1","25%");
                        page.inputText("birthDate", "", "130px");
                    page.endCell();
                page.endRow();    
                page.startRow();
                    page.startCell("","1","1","25%");
