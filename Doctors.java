 ...
 * Doctors.java
 * 
 * Created on Sep 5, 2007, 11:33:25 AM
 * 
...
public class Doctors extends HttpServlet {
    ...
    */
    ...
    throws ServletException, IOException {
        ...
        Page page=view.initialize("Doctors","global.css");
...
// ** TITLE **            
// ********************************            
            page.text("Doctors", "titletext", "patients.jpg", "", "", "210px", "125px", "300px", "35px", "3", "35px", "35px");
// ********************************
// ** MAIN SUB MENU **            
// ********************************            
            page.startTable("stdgrid","200px","175px","468px","30px","4");
                page.startRow();
                    page.startCell("extralinkcell","1","1","");
                        ...
                        //page.space();
                        //page.space();
                        page.text("New Doctor", "extralinktext", "insert.jpg", "", "doctor?command=2", "35px", "35px");
                    page.endCell();
                page.endRow();
            page.endTable(true);
            ...
            page.startTable("boxgrid","200px","220px","468px","3");
                ...
                for (int i=0; i<doctors.size(); i++) {
                    ...
                    page.startRow();
                        page.startCell("", "1", "1", "");
                            page.text(doctor.getFirstName()+" "+doctor.getLastName()+" "+doctor.getMiddleName(), "extralinktext", "", "", "doctor?id="+doctor.getPartyId(), "", "");
                        page.endCell();
                    page.endRow();                
                }                
            page.endTable(false);
