 ...
 * Company.java
 * 
 * Created on Aug 25, 2007, 5:53:04 PM
 * 
...
public class Company extends HttpServlet {
    ...
    */
    ...
    throws ServletException, IOException {
        ...
        Page page=view.initialize("Company Profile","global.css");
        ...
        login.setLastForm("company");
        request.getSession().setAttribute("login", login);
// ********************************
// ** TITLE **            
// ********************************            
            page.text("Company Profile", "titletext", "", "", "", "210px", "125px", "300px", "35px", "3", "", "");
