 ...
 * Services.java
 * 
 * Created on Aug 25, 2007, 5:54:28 PM
 * 
...
public class Services extends HttpServlet {
    ...
    */
    ...
    throws ServletException, IOException {
        ...
        Page page=view.initialize("Services","global.css");
        ...
        login.setLastForm("services");
        request.getSession().setAttribute("login", login);
// ********************************
// ** TITLE **            
// ********************************            
            page.text("Services", "titletext", "", "", "", "210px", "125px", "300px", "35px", "3", "", "");
