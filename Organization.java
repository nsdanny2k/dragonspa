 ...
 * Organization.java
 * 
 * Created on Aug 25, 2007, 5:54:58 PM
 * 
...
public class Organization extends HttpServlet {
    ...
    */
    ...
    throws ServletException, IOException {
        ...
        Page page=view.initialize("Organization","global.css");
        ...
        login.setLastForm("organization");
        request.getSession().setAttribute("login", login);
// ********************************
// ** TITLE **            
// ********************************            
            page.text("Organization", "titletext", "", "", "", "210px", "125px", "300px", "35px", "3", "", "");
