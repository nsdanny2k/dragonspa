/*
 * LayerGroupSystemLong.java
 * 
 * Created on Sep 9, 2007, 6:16:37 PM
 * 
 ...
 * @author nsdan2k
 */
public class LayerGroupSystemLong {

    public LayerGroupSystemLong(Page region,HttpServletRequest request, HttpServletResponse response) {
