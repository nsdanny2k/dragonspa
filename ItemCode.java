 ...
 * ItemCode.java
 * 
 * Created on Oct 17, 2007, 11:58:50 AM
 * 
 ...
 * @author nsdan2k
 */
public class ItemCode extends HttpServlet {
    ...
    */
    ...
    throws ServletException, IOException {
        ...
        model.ItemCode code=new model.ItemCode();
                ...
                if (code.save()) {
                    ...
                    page.startTable("stdgrid","200px","210px","468px","30px","4");
                        ...
                        if (pg!=null) {
                            page.startRow();
                                page.startCell("","1","1","");
                                    page.text("Return to list","","","","itemcodes?pg="+pg,"25px","25px");
                                page.endCell();
                            page.endRow();
                        }                         
                        page.startRow();
                            page.startCell("","1","1","");
                                page.text("Add another record","","insert.jpg","","Itemcode?command=2","25px","25px");
                            page.endCell();
                        page.endRow();
                    page.endTable(true);
                    page.flush();
...
// ********************************            
            ...
            page.startForm("editcode", "itemcode", "post");
