 ...
 * Frontdesk.java
 * 
 * Created on Feb 4, 2008, 2:37:12 PM
 * 
 ...
 * @author nsdan2k
 */
public class Frontdesk extends HttpServlet {
    ...
    */
    ...
    throws ServletException, IOException {
        ...
        Page page=view.initialize("Frontdesk","global.css");
        ...
        if (checkin!=null) {
            ...
            if (request.getParameter("dentalUnit").equals("")) {
                ...
                if (Tid==0) {
                    page.text("Frontdesk", "titletext", "", "", "", "210px", "125px", "300px", "35px", "3", "35px", "35px");
                    ...
                    ctr.forward("room?id="+Tid, request, response);
                 }
            }
        }
...
// ** TITLE **            
// ********************************            
            page.text("Frontdesk", "titletext", "chair.png", "", "", "210px", "125px", "300px", "35px", "3", "35px", "35px");
// ********************************
// ** MAIN SUB MENU **            
// ********************************            
...
// ********************************            
            page.startTable("boxgrid","200px","230px","472px","300px","4");
                ...
                for (int i=0; i<exams.size(); i++) {
                    ...
                    page.startRow();
                        page.startForm("examform", "frontdesk", "post");
                        page.startCell("","1","1","");
                            page.text(exam.getDentalUnit(), "", "file.jpg", "Treatment", "room?id="+exam.getTreatmentId(), "25px", "25px");
                        page.endCell();
                        page.startCell("","1","1","");
                            page.text(exam.getPatient(), "extralinktext", "", "", "room?id="+exam.getTreatmentId(), "", "");
                        page.endCell();
                        page.startCell("","1","1","");
                ...
                if (checkin!=null) {
                    ...
                    page.startRow();
                        page.startCell("","1","1","");
                            ...
                            page.inputText("dentalUnit", request.getParameter("dentalUnit"), "50px");
                    ...
                    if (iCheckin==0 && !request.getParameter("patient").equals("")) {
                        page.startRow();
                            page.startCell("","1","5","");
                                page.text("Guest not found.", "errortext");
                            page.endCell();
                        page.endRow(); 
                    } else if ( iCheckin>1) {
                    ...
                    if (request.getParameter("dentalUnit").equals("")) {
                         page.startRow();
                            page.startCell("","1","5","");
                                page.text("Please specify a room.", "errortext");
                            page.endCell();
                        page.endRow();                        
                    }
                    page.endForm();
                    ...
                    page.startRow();
                        ...
                        page.startCell("","1","1","");
                            ...
                            page.inputText("dentalUnit", "", "50px");
                            //page.image("insert.jpg", "Select Patient", "", "25px", "25px");
                            page.endCell();
                        page.startCell("","1","1","");
                            model.Patients ps=new model.Patients();
