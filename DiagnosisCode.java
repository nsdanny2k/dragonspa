 ...
 * DiagnosisCode.java
 * 
 * Created on Sep 11, 2007, 11:58:50 AM
 * 
 ...
 * @author nsdan2k
 */
public class DiagnosisCode extends HttpServlet {
    ...
    */
    ...
    throws ServletException, IOException {
        ...
        login.setLastForm("diagnosiscode");
        ...
        if (login.getAccountId().equals("system")) {
            page=view.initialize("Diagnosis Code","global.css","System");    
        } else {
            page=view.initialize("Diagnosis Code","global.css");
        }                
        model.DiagnosisCode code=new model.DiagnosisCode();
        ...
        if ((save!=null)) {
            if (!(code.getCode().equals("")) && !(code.getDescription().equals(""))) {
                ...
                if (code.save()) {
                    page.text("Diagnosis Code", "titletext", "", "", "", "210px", "125px", "300px", "35px", "3", "", "");
                    page.startTable("stdgrid","200px","210px","468px","30px","4");
                        ...
                        if (pg!=null) {
                            page.startRow();
                                page.startCell("","1","1","");
                                    page.text("Return to list","","","","diagnosiscodes?pg="+pg,"25px","25px");
                                page.endCell();
                            page.endRow();
                        }                         
                        page.startRow();
                            page.startCell("","1","1","");
                                page.text("Add another record","","insert.jpg","","diagnosiscode?command=2","25px","25px");
                            page.endCell();
                        page.endRow();
                    page.endTable(true);
                    page.flush();
...
// ********************************            
            ...
            page.startForm("editcode", "diagnosiscode", "post");
